...
//          log.info("file="+file);
     ...
     */
    private static HTMLElementImpl[] getValidURLElement(Document doc) {
        if (doc == null) {
            return null;
        }
        ...
        for (int i = 0; i < validElements.length; i++) {
            ...
            if (elements == null || elements.getLength() == 0) {
                elements = doc.getElementsByTagName(elementName.toUpperCase());
                if (elements == null || elements.getLength() == 0)
                    continue;
            }
     ...
     * @return
     */
    private static String[] getValidURLAttributeValues(Document doc) {
     ...
     * @throws SAXException
     */
    public static Document parse(String strURL) throws SAXException {
    ...
    public static void main(String[] args) throws IOException, SAXException {
        Document doc = parse("http://www.cfan.com.cn/images/images/hardware_error_03.gif");
        if (doc == null) {
            log.info("Can not get document by parse!");
            return;
        }
